...
import { ListsState, NEW_LIST_STATE, createTokenListReducer, type ListByUrlState } from './reducer'

const DEFAULT_ACTIVE_LIST_URLS: string[] = []
const DEFAULT_LIST_OF_LISTS = ['https://assets.betterx.pro/tokens/pancakeswap-extended.json']
