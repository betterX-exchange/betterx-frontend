...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://assets.betterx.pro/tokens/address/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://assets.betterx.pro/tokens/address/${token.address[56]}.png`;
        const secondarySrc = `https://assets.betterx.pro/tokens/address/${tokens[randomTokenIndex].address[56]}.png`;
