...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">BetterX Swap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        BetterX Swap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive,
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. BetterX Swap does not control or operate any version of the Protocol on any
        ...
        matter, the BetterX Swap team is not a liquidity provider into Protocol liquidity pools and liquidity providers
      ...
      <Text as="p">
        BetterX Swap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the BetterX Swap default token list and
        BetterX Swap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
