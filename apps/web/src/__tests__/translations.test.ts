...
const whitelist = [
  ...
  'Latest News about BetterX Swap and more!',
  'Gaming Announcements',
  'BetterX Swap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with BetterX Swap Now',
  'Bring Your Game to Life on BetterX Swap',
  ...
  'BetterX Swap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'BetterX Swap Gaming Marketplace',
  'Play, Build and Connect on BetterX Swap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
