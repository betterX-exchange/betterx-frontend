...
const config = [
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          In the Public Sale, everyone with an active BetterX Swap profile can commit. However the maximum amount of
  ...
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active BetterX Swap Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
