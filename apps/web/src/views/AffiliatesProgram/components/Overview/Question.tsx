    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a BetterX Swap affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t('Strong understanding of BetterX Swap and our ecosystem')}
              </StyledListText>
            </FoldableText>
            <FoldableText title={t('How do I earn commissions as an affiliate?')} mt="24px">
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t('Pairs must be in the BetterX Swap Token list for the following chains (')}
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-extended.json"
                >
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-arbitrum-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('Arbitrum One')},
                  </Text>
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-base-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('Base')},
                  </Text>
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-eth-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('Ethereum')},
                  </Text>
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-linea-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('Linea')},
                  </Text>
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-polygon-zkevm-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('Polygon zkEVM')},
                  </Text>
                ...
                <Link
                  external
                  style={{ display: 'inline-block' }}
                  href="https://tokenlists.org/token-list?url=https://assets.betterx.pro/tokens/pancakeswap-zksync-default.json"
                >
                  <Text color="primary" ml="4px" as="span">
                    {t('zkSync Era')}
                  </Text>
