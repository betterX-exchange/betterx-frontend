...
const Menu = (props) => {
  ...
  const [onPerpConfirmModalPresent] = useModal(
    <USCitizenConfirmModal title={t('BetterX Swap Perpetuals')} id={IdType.PERPETUALS} href={perpUrl} />,
    true,
    false,
    'perpConfirmModal',
  )
  ...
  return (
    <>
      <UikitMenu
        ...
        buyCakeLabel={t('Buy BetterX')}
        buyCakeLink="https://betterX.pro/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82&chainId=56"
        {...props}
      />
    </>
  )
